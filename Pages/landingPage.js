  ...
  return (
    ...
    <div className="introduction-container">
      ...
      <div className="introduction-text">
        ...
        <p className="introduction-paragraph">
          At Nenasara Institute, we believe in the holistic development of our students. We offer a wide range of programs and courses that cater to diverse interests and career aspirations. Our faculty members are experts in their respective fields, committed to mentoring and guiding students towards their goals. 
        </p>
        <p className="introduction-paragraph">
          Our campus is equipped with modern amenities, including advanced laboratories, a well-stocked library, and collaborative learning spaces, providing an environment conducive to learning and innovation. We also emphasize extracurricular activities, encouraging students to participate in sports, arts, and community service to develop well-rounded personalities.
        </p>
        <p className="introduction-paragraph">
